...
def find_sum(root,my_dict):
	...
	my_dict[root.data]= left_sum+right_sum+int(root.data)
	return my_dict[root.data]
...
def find_tilt(root,my_dict):
	...
	# 	root.data=abs(int(my_dict[root.left.data])-int(my_dict[root.right.data]))
	# if root.left !=None and root.right ==None:
	# 	root.data=my_dict[root.left.data]
	# if root.right != None and root.left==None:
	# 	root.data=my_dict[root.right.data]
	# if root.left==None and root.right==None:
	# 	root.data=0
